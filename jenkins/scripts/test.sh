...
echo 'The following "pnpm" command (if executed) installs the "cross-env"'
...
echo 'https://docs.pnpmjs.com/cli/install, the "--save-dev" flag causes the'
...
echo 'The following "pnpm" command tests that your simple Node.js/React'
echo 'application renders satisfactorily. This command actually invokes the test'
echo 'runner Jest (https://facebook.github.io/jest/).'
set -x
CI=true pnpm test -- --passWithNoTests --testTimeout=10000
